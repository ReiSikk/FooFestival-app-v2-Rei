...
import fullHeart from "../../media/full-heart.svg";
...
function BandCard(props) {
  ...
  const toBandPage = () => {
    navigate(`/band-page/${props.bandName === "AC/DC" ? "ACDC" : props.bandName}`, {
      state: { pageName: props.bandName, data: props.data },
    });
  };
          ...
          {props.favouriteList != undefined ? (
            props.favouriteList.find((band) => band === props.bandName) ? (
              ...
              <img
                ...
                src={emptyHeart}
                alt="Add to favourites heart icon"
              />
            )
          ) : null}
        </div>
